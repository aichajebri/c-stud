...
int num;
//cin.ignore();
cout<<"Donner le niveau:(10 caracteres)"<<endl;
do{
getline(cin,niveau);
}while(niveau.length()>10);
cout<<"Donner le diplome:(10 caracteres)"<<endl;
do{
getline(cin,diplome);
}while(diplome.length()>10);
cout<<"Donner la specialité:(10 caracteres)"<<endl;
do{
getline(cin,specialite);
}while(specialite.length()>10);
cout<<"Donner le numero du groupe:(10 caracteres)"<<endl;
cin>>num;
