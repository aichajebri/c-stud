...
case 1:
choix=-1;
cout <<"Donner un numero d'inscription:(10000-99999)";
do{
cin>>num;
}
...
cout<<"étudiant trouver, veuillez saisir les nouvelles informations:"<<endl;
e.setNum(num);
e.read_Attributes();
...
case 3:
choix=-1;
cout <<"Donner le numero de l'étudiant a suprimer:";
cin>>num;
...
case 1:
choix=-1;
cout <<"Donner le numero de l'étudiant:";
cin>>num;
...
case 2:
choix=-1;
cout <<"Donner le numero de l'étudiant pour modifier la note:";
cin>>num;
i=Verifier_Exist_Etudiant(etd,num);
if(i!=-1){
...
case 3:
choix=-1;
cout <<"Donner le numero de l'étudiant pour suprimer la note:";
cin>>num;
i=Verifier_Exist_Etudiant(etd,num);
if(i!=-1){
...
case 4:
choix=-1;
cout<<"Les Matieres enregistrer sont:"<<endl;
g1.Display_Mat();
break;
case 5:return -1;break;
default:cout<<"erreur de choix"<<endl;break;
